...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    expected_real = torch.mean((scores_real - 1) ** 2)
    expected_fake = torch.mean(scores_fake ** 2)
    loss = expected_real / 2 + expected_fake / 2
...
def ls_generator_loss(scores_fake):
    ...
    expected_fake = torch.mean((scores_fake - 1) ** 2)
    loss = expected_fake / 2
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    return loss
